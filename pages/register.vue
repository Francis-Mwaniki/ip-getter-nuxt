<template>
  <!-- component -->
<section id="contact" class="relative w-full min-h-screen bg-slate-900 md:mt-4 mt-12 text-red-500">
...
<div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
    ...
    <div class="bg-gray-900 border border-red-500 w-full lg:w-1/2 h-full p-5 pt-8">
        ...
        <a href="https://github.com/Francis-Mwaniki" class="flex items-center hover:text-white hover:bg-red-500 p-2">
        ...
        <a href="https://www.linkedin.com/in/francis-mwaniki-378603220" class="flex items-center hover:text-white hover:bg-red-500 p-2">
        ...
        <a href="https://www.facebook.com/profile.php?id=100073476542957" class="flex items-center hover:text-white hover:bg-red-500 p-2">
            <svg fill="currentColor" class="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
    ...
    <!-- Contact Me -->
    <form action="" @submit.prevent="submit" class="w-full md:w-1/2 border border-red-500 p-6 bg-gray-900">
  ...
  methods: {
    async submit() {
      ...
      if (res.ok) {
        ...
        console.log(data);
        alert(`${this.name} your account was created`)
