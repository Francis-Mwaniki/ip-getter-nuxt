...
<div class="flex min-h-screen bg-slate-900">
    <div class="relative flex justify-center max-w-full py-4 m-auto bg-white shadow-2xl px-7">
        ...
        <div class="w-1/2 ml-1 bg-cover m-1" style="background-image:url('https://media.istockphoto.com/id/1440433765/photo/users-accessing-website-through-virtual-private-network-to-hide-the-internet-traffic-online.jpg?b=1&s=170667a&w=0&k=20&c=kQ19_h9cR9hz75p6-RGIoxpIEWHL9KjYB-mOBdA8Pks=')">
        </div>
