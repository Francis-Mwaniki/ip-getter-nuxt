<template>
  <main>
    <div class="bg-slate-900 shadow-lg h-24 hidden md:flex">
      ...
      <nav class="div-links contents font-semibold text-base lg:text-lg">
        <ul class="flex items-center ml-4 xl:ml-8 mr-auto">
          ...
          <li
            class="p-3 xl:p-6 bg-red-600 hover:bg-pink-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded"
          >
    ...
    <div
      class="bg-slate-900 shadow-lg h-24 flex-col justify-center items-center md:hidden flex"
    >
